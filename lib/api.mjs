...
// propagate into the DKG). Returns true if the gate opened within the timeout.
export async function ensureConsentAnchored(patientId, doctorId, organizationId, timeoutMs = 45000) {
